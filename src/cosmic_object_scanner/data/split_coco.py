...
def move_images(data: dict[str, Any], source_dir: str, target_dir: str) -> None:
    for img in data["images"]:
        img_filename = img["file_name"]
        shutil.copy(os.path.join(source_dir, img_filename), os.path.join(target_dir, img_filename))
...
def main() -> None:
    ...
    with open(f"{DATASET_DIR}/result.json") as f:
    ...
    train_ids, test_ids = train_test_split(image_ids, test_size=0.20, random_state=42)
